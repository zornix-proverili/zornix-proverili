...
I enjoy building websites and web applications while learning **Frontend**, **Backend**, **Cloud**, **Server**, and **Network**.
I'm planning to start my career as an **Infrastructure Engineer** after graduating from vocational school.

# 🌱 Vision
- Build meaningful products.
- Start my own company.
- Create services that help people and continue creating value.

# 🎓 Education
- 🎨 Art Club (6 years)
- 🖌️ High School – Art Course
- 💻 Web Development Major (Vocational School)

### Future Education
- Online University (Transfer as a Third-Year Student)

# 📚 Learning Fields
- 🌐 Frontend Development | ⚙️ Backend Development | ☁️ Cloud Computing
- 🖥️ Server Administration | 🌍 Networking | 🗄️ Database Design
- 🔒 Web Security | 🏗️ System Architecture

# 📖 Certification Goal
- ☁️ Cloud Certifications | 🖥️ Infrastructure Certifications
- 🌐 Networking Certifications | 🔒 Security Certifications

# 🚀 Current Projects
- 💎 **Clari Jewelry** — Jewelry e-commerce.

### 🗂️ Planned Projects
- 💬 **Communicate** | 📝 **Blog Platform**
- 📘 **HTML for Beginners** | 🎨 **CSS for Beginners**
...
![Google Slides](https://img.shields.io/badge/Google_Slides-FBBC04?style=for-the-badge&logo=googleslides&logoColor=white)
</details>
...
# 👋 自己紹介
駆け出し初心者のフルスタックエンジニア。
**フロントエンド**、**バックエンド**、**クラウド**、**サーバー**、**ネットワーク**を学習、趣味でWebサイトやWebアプリケーションの構築をしてる。
専門学校を卒業した後は、**インフラエンジニア**としてのキャリアをスタートする。

# 🌱 ビジョン
- 価値のあるプロダクトを作る。
- 自分の会社を立ち上げる。
- 人々の役に立つサービスを創り、価値を提供し続ける。
...
# 📚 学習分野
- 🌐 フロントエンド開発 | ⚙️ バックエンド開発 | ☁️ クラウドコンピューティング
- 🖥️ サーバー管理 | 🌍 ネットワーク | 🗄️ データベース設計
- 🔒 Webセキュリティ | 🏗️ システムアーキテクチャ

# 📖 取得目標資格
- ☁️ クラウド関連資格 | 🖥️ インフラ関連資格
- 🌐 ネットワーク関連資格 | 🔒 セキュリティ関連資格

# 🚀 現在のプロジェクト
- 💎 **Clari Jewelry** — ジュエリーのECサイト。

### 🗂️ 計画中のプロジェクト
- 💬 **Communicate** | 📝 **ブログプラットフォーム**
- 📘 **初心者向けHTML** | 🎨 **初心者向けCSS**
...
# 👋 关于我
我是来自日本的初学者全栈开发人员。
开心地构建网站和Web应用程序，同时学习 **前端**、**后端**、**云端**、**服务器** 和 **网络**。
计划在从职业学校毕业后，开始作为 **基础架构工程师** 的职业生涯。
...
웹사이트와 웹 애플리케이션을 구축하는 것을 즐기며, **프론트엔드**, **백엔드**, **클라우드**, **서버**, **네트워크**를 공부하고 있습니다.
전문학교 졸업 후 **인프라 엔지니어**로 커리어를 시작할 계획입니다.

# 🌱 비전
- 의미 있는 제품을 만듭니다.
- 나만의 회사를 설립합니다.
- 사람들에게 도움이 되고 지속적인 가치를 창출하는 서비스를 만듭니다.
...
# 📚 학습 분야
- 🌐 프론트엔드 개발 | ⚙️ 백엔드 개발 | ☁️ 클라우드 컴퓨팅
- 🖥️ 서버 관리 | 🌍 네트워킹 | 🗄️ 데이터베이스 설계
- 🔒 웹 보안 | 🏗️ 시스템 아키텍처

# 📖 자격증 목표
- ☁️ 클라우드 관련 자격증 | 🖥️ 인프라 관련 자격증
- 🌐 네트워크 관련 자격증 | 🔒 보안 관련 자격증

# 🚀 진행 중인 프로젝트
- 💎 **Clari Jewelry** — 주얼리 이커머스 웹사이트.

### 🗂️ 계획 중인 프로젝트
- 💬 **Communicate** | 📝 **블로그 플랫폼**
- 📘 **초보자를 위한 HTML** | 🎨 **초보자를 위한 CSS**
...
Disfruto creando sitios web y aplicaciones web mientras aprendo **Frontend**, **Backend**, **Cloud**, **Server** y **Network**.
Planeo comenzar mi carrera como **Ingeniero de Infraestructura** después de graduarme de la escuela vocacional.

# 🌱 Visión
- Crear productos significativos.
- Iniciar mi propia empresa.
- Crear servicios que ayuden a las personas y sigan aportando valor.

# 🎓 Educación
- 🎨 Club de Arte (6 años)
- 🖌️ Escuela Secundaria – Bachillerato de Arte
- 💻 Especialización en Desarrollo Web (Escuela Vocacional)

### Educación Futura
- Universidad en Línea (Transferencia como Estudiante de Tercer Año)

# 📚 Campos de Aprendizaje
- 🌐 Desarrollo Frontend | ⚙️ Desarrollo Backend | ☁️ Computación en la Nube
- 🖥️ Administración de Servidores | 🌍 Redes | 🗄️ Diseño de Bases de Datos
- 🔒 Seguridad Web | 🏗️ Arquitectura de Sistemas

# 📖 Objetivos de Certificación
- ☁️ Certificaciones de Nube | 🖥️ Certificaciones de Infraestructura
- 🌐 Certificaciones de Redes | 🔒 Certificaciones de Seguridad

# 🚀 Proyectos Actuales
- 💎 **Clari Jewelry** — Comercio electrónico de joyería.

### 🗂️ Proyectos Planificados
- 💬 **Communicate** | 📝 **Plataforma de Blog**
- 📘 **HTML para Principiantes** | 🎨 **CSS para Principiantes**
