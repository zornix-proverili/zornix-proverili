...
# 👋 About Me / 自己紹介
**English** | Aspiring Infrastructure Engineer with an upcoming career launch. Committed to mastering Cloud, Networking, and Server administration to excel in professional environments. I am strategically augmenting my infrastructure expertise with Web Development (Frontend/Backend) and business-critical tools like Microsoft Office. My goal is to build a high-performance technical toolkit that integrates system architecture, design, and operations.

**日本語** | インフラエンジニアとして内定済み。入社後の即戦力化を目指し、クラウド・ネットワーク・サーバー領域の専門性を深めるフェーズにあります。業務遂行能力を強化するため、Web開発（フルスタック）およびビジネスツール（Microsoft Office）の習得を継続。また、技術スタックの幅を広げるため、デザイン領域のスキルも実務レベルへ引き上げています。キャリアの土台を強固にすることを目的とした戦略的な技術習得を行っています。

# 🌱 Professional Goals / キャリア目標
...
## 🧰 Productivity Tools
<p>
  <img src="https://img.shields.io/badge/Microsoft_Word-2B579A?style=flat&logo=microsoftword&logoColor=white">
  <img src="https://img.shields.io/badge/Microsoft_Excel-217346?style=flat&logo=microsoftexcel&logoColor=white">
  <img src="https://img.shields.io/badge/Microsoft_PowerPoint-B7472A?style=flat&logo=microsoftexcel&logoColor=white">
  <img src="https://img.shields.io/badge/Google_Docs-4285F4?style=flat&logo=googledocs&logoColor=white">
  <img src="https://img.shields.io/badge/Google_Sheets-34A853?style=flat&logo=googlesheets&logoColor=white">
  <img src="https://img.shields.io/badge/Google_Slides-FBBC04?style=flat&logo=googleslides&logoColor=white">
</p>
